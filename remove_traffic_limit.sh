...
# 下载并运行新的管理器
echo "正在下载机器限速管理器..."
curl -fsSL https://raw.githubusercontent.com/Misasasasasaka/TrafficCop/main/machine_limit_manager.sh -o /tmp/machine_limit_manager.sh
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "如需恢复监控，请运行:"
    echo "bash <(curl -sL https://raw.githubusercontent.com/Misasasasasaka/TrafficCop/main/machine_limit_manager.sh)"
